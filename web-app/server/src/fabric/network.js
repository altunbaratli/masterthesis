...
exports.createCar = async function(key, tempA, tempB, tempC, owner) {
    let response = {};
    try {
        ...
        await contract.submitTransaction('createMt', key, tempA, tempB, tempC, owner);
        console.log('Transaction has been submitted');

        // Disconnect from the gateway.
        await gateway.disconnect();

        response.msg = 'createMt Transaction has been submitted';
        return response;
...
exports.queryAllCars = async function() {
    ...
    try {
        ...
        const result = await contract.evaluateTransaction('queryAllMts');
        //console.log('check6');
